...
public class MainClientSpring extends Application {
    ...
    private void initWindow(Stage primaryStage) throws Exception {
        ...
        loader2.setLocation(getClass().getClassLoader().getResource("views/GameView.fxml"));
        AnchorPane layout3 = loader2.load();
        GameController gameController = loader2.getController();
